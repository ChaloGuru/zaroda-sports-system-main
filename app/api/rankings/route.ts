...
export async function GET(request: Request) {
  try {
    ...
    const pointsScopeParam = searchParams.get("pointsScope"); // ALL | KNOCKOUT_ONLY | GROUP_ONLY | null=ALL
    ...
    const organizationRankings = await computeOrganizationRankings(championshipId, {
      ...
      pointsScope:
        pointsScopeParam === "KNOCKOUT_ONLY" || pointsScopeParam === "GROUP_ONLY" ? pointsScopeParam : "ALL",
    });
